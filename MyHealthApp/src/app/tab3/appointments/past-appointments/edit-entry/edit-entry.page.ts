...
export class EditEntryPage {
  ...
  async update(rowid) {
    ...
    const alert = await this._alertController.create({
      ...
      message:
        'Would you like to update this entry in your appointments? <br/><br/>Note: if the date is in the future, the appointment will be placed in your upcoming appointments!',
      buttons: [
        {
          text: 'Cancel',
        },
