...
export class EditEntryPage {
  ...
  async update(rowid) {
    ...
    const alert = await this._alertController.create({
      ...
      message:
        'Would you like to update this entry in your procedures? <br/><br/>Note: if the date is in the future, the procedure will be placed in your upcoming procedures!',
      buttons: [
        {
          text: 'Cancel',
        },
